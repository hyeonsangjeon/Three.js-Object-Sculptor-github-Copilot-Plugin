...
Use this reference when writing or reviewing an `ObjectSculptSpec`. The goal is to describe what Copilot should build in terms a Three.js/technical-artist workflow can act on.
